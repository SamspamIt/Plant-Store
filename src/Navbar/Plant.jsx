...
import bg from '../assets/Plant Store/Plantbg.avif';
import bg1 from '../assets/Plant Store/Plantbg1.png';
import bg2 from '../assets/Plant Store/Plantbg2.png';
import bg3 from '../assets/Plant Store/Plantbg3.png';
import bg4 from '../assets/Plant Store/Plantbg4.jpg';
import bg5 from '../assets/Plant Store/Plantbg5.jpg';
import bg6 from '../assets/Plant Store/Plantbg6.jpg';
import bg7 from '../assets/Plant Store/Plantbg7.jpg';
import bg8 from '../assets/Plant Store/Plantbg8.jpg';
// import bg9 from '';
// import bg10 from '';

const products=[
    { id:1, name:"Crassula", price:"$19.99", image:bg1},
    { id:2, name:"Rhapis Palm", price:"$14.99", image:bg2},
    { id:3, name:"Alokazia Amazonian", price:"$23.99", image:bg3},
    { id:4, name:"Anthurium Clarinervium", price:"$16.49", image:bg4},
    { id:5, name:"Cereus", price:"$15.00", image:bg5},
    { id:6, name:"Monstera", price:"$26.99", image:bg6},
    { id:7, name:"Cactus", price:"$19.99", image:bg7},
    { id:8, name:"Schefflera Arboricola", price:"$24.74", image:bg8},
    { id:9, name:"Zamioculcas", price:"$19.99", image:bg},
    { id:10, name:"Ficus Lyrata", price:"$35.99", image:bg},
    ...
    return (
        <div className=" bg-black text-white min-h-screen flex pt-32">
            ...
            <div className="w-52 min-w-52 px-6 py-10 border-r border-gray-800 ">
                ...
                {/* Banner Image */}
                <img src={bg} alt="Plants Banner"
                    className="w-full h-64 object-cover mb-8"/>
                {/* Heading */}
                <h1 className="text-6xl font-cormorant font-light mb-2">Plants</h1>
                <p className="text-sm text-gray-400 mb-8">{products.length} products</p>
